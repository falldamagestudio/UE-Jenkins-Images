function Setup-DockerRegistryAuthentication {
	param (
	...
	Copy-Item -Path $AgentKeyFile -Destination "${GCloudConfigFolder}\application_default_credentials.json" -ErrorAction Stop
}